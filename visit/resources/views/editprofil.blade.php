                        ...
                        <div class="row g-0" id="editData">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="email" class="form-control" name="email"
                                                        autocomplete="off" value="{{ $user->email1 }}" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="jenis_bank" required>
                                                        ...
                                                        <option value="bri" @selected($user->jenis_bank == 'bri')>BRI</option>
                                                        <option value="bca" @selected($user->jenis_bank == 'bca')>BCA
                                                        <option value="bni" @selected($user->jenis_bank == 'bni')>BNI
                                                        </option>
                                                        <option value="bankjateng" @selected($user->jenis_bank == 'bankjateng')>Bank
                                                            Jateng
                                                        </option>
                                                        <option value="mandiri" @selected($user->jenis_bank == 'mandiri')>
                                                            Mandiri</option>
                                                    </select>
                                    ...
                                    <a href="profil"><button class="btn btn-danger">Batal</button></a><br><br>
