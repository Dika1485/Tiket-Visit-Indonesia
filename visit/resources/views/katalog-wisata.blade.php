                ...
                <div class="box-fitur-active" style="transform: rotate(0);">
                    <div class="row">
                        <div class="col col-lg-2" style="padding: 0px;text-align: center;"><i
                                class="bi bi-strava"></i></div>
                        <div class="col">
                            <h6 style="margin-bottom: 0px;">Destinasi</h6>
                        </div>
                        <div class="col col-lg-2" style="padding: 0px;text-align: center;">6</div>
            ...
            <div class="col d-flex">
                <div class="container px-6 text-center">
                    <div class="row gx-5 mb-3">
                            ...
                            <div class="box-katalog"
                                ...
                                <div class="modal" id="beli" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content ">
                                            <div class="modal-header">
                                                <h5 class="modal-title" style="margin-left: 16px;">Nama Destinasi</h5>
                                                    ...
                                                    <div class="col" style="margin: auto;">
                                                        ...
                                                        <div class="row" style="vertical-align: middle;">
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td align="left">Harga : Rp 20.000/tiket</td>
                                                                    </tr>
                                                                    <tr>
                        ...
                        <div class="col">
                            <div class="box-katalog">Custom column padding</div>
                        </div>
                        <div class="col">
                            <div class="box-katalog">Custom column padding</div>
                        </div>
