...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="about.html">Notifikasi</a></li>
          <li><a href="services.html">Favorit</a></li>
          <li><a href="pricing.html">Pesanan</a></li>
    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <p data-aos="fade-up" data-aos-delay="100">Nikmati rekreasi bersama orang favoritmu, dan buatlah memori di Purbalingga!</p>
  ...
  <main id="main">
    ...
    <section id="about" class="about pt-0">
      <div margin-top="50px"  class="container" data-aos="fade-up">
